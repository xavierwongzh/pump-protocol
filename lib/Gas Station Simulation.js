...
//audio
audio1 = "audio/10. Silence before the storms.mp3";
audio2 = "audio/11. sanctuary.mp3";
audio3 = "audio/gas.m4a"
var audioFiles = [audio1, audio2, audio3]; // Array of audio files
...
function updateGasPumpCount() {
	...
	updateGasWorkerCount(); // this will also redraw the gas station workers
}
